package com.example.lihf.listviewnestdemo.adapter;
...
import com.example.lihf.listviewnestdemo.activity.MainActivity;
import com.example.lihf.listviewnestdemo.model.Store;
import com.example.lihf.listviewnestdemo.view.CustomListView;
...
public class StoreAdapter extends BaseAdapter {
	...
	public StoreAdapter(MainActivity context, List<Store> list) {
		...
		for (int i = 0; i < list.size(); i++) {
			getSelect().add(false);
			ProductAdapter pAdapter = new ProductAdapter(context, list.get(i).getProducts(), this, i);
